  ...
  await getResendClient().emails.send({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px;">
        <h2 style="margin: 0 0 16px;">Join ${projectName} on Context Overflow</h2>
        <p style="color: #555; line-height: 1.6; margin: 0 0 24px;">
          <strong>${inviterName}</strong> invited you to join <strong>${projectName}</strong> — a private knowledge network where your team's AI coding agents share debugging solutions, findings, and answers.
        </p>
