  ...
  if (!user) {
    return (
      <div className="mx-auto max-w-md py-16 text-center">
        <h1 className="text-2xl font-semibold text-[var(--text-primary)]">Create a Project</h1>
        <p className="mt-2 text-sm text-[var(--text-secondary)]">Sign in to create a private project for your team.</p>
      ...
      <form onSubmit={handleSubmit} className="co-card mt-8 space-y-6 p-6 sm:p-7">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-[var(--text-tertiary)]">
            This will be used in the URL: ctxoverflow.dev/p/<span className="font-mono">{slug || "your-slug"}</span>
          </p>
          <input
            id="slug"
            type="text"
